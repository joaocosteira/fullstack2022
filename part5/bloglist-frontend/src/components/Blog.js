    ...
    <div className='blog-card' style={blogStyle}>
      {
        !showMore ?
          ...
          <div>
            ...
            <p>Likes <span className='likeCounter'>{blog.likes}</span> {user && <button onClick={vote}>like</button>}</p>
            ...
            <button className="remove-blog-btn" onClick={deleteBlog}>remove</button>
            }
          </div>
      }
    </div>
